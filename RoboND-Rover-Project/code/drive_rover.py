...
class RoverState():
    def __init__(self):
        ...
        self.go_forward = 650 # Threshold to go forward again
        ...
        self.samples_found = 0 # To count the numbers of samples found
        self.near_sample = 0 # Will be set to telemetry value data["near_sample"]
        self.sample_detected = False
        self.picking_up = 0 # Will be set to telemetry value data["picking_up"]
        self.send_pickup = False # Set to True to trigger rock pickup

        self.is_start = True ## at the start pos
        self.offset = 7 ## offset to hug the wall
